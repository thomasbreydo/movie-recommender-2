...
def annotate(examples,
             ...
             include_skip=True,
             display_fn=display):
    # Modified from https://github.com/agermanidis/pigeon
    """
    ...
    def save_annotation(rating):
        movieId = examples[current_index]
        _save_annot((movieId, rating), user=user)
        show_next()
